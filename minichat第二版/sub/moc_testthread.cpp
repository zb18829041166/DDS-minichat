...
static const char qt_meta_stringdata_TestThread[] = {
    "TestThread\0\0data\0publishDDS(QString)\0"
};
...
void TestThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->publishDDS((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData TestThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TestThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_TestThread,
      qt_meta_data_TestThread, &staticMetaObjectExtraData }
};
