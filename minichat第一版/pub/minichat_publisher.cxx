/* minichat_publisher.cxx

   A publication of data of type MiniChat
   ...
   Example publication of type MiniChat automatically generated by 
   ...
   Example:
       ...
       objs/<arch>/minichat_publisher <domain_id> o
...
extern "C" int publisher_main(int domainId, int sample_count)
{
 ...
 instance = MiniChatTypeSupport::create_data();
    ...
    const char *a="1";
    strncpy(instance->MiniChat,a,32);
    //instance='hellw';
    if (instance == NULL) {
        printf("MiniChatTypeSupport::create_data error\n");
        publisher_shutdown(participant);
        return -1;
    }
...
/*
    instance_handle = MiniChat_writer->register_instance(*instance);
*/
