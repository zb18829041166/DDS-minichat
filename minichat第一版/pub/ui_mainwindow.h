...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gif->setMaximumSize(QSize(16777215, 200));
        ...
        showMessageEdit = new QTextEdit(centralWidget);
        showMessageEdit->setObjectName(QString::fromUtf8("showMessageEdit"));

        verticalLayout->addWidget(showMessageEdit);

        writeMessageEdit = new QTextEdit(centralWidget);
        writeMessageEdit->setObjectName(QString::fromUtf8("writeMessageEdit"));

        verticalLayout->addWidget(writeMessageEdit);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        gif->setText(QApplication::translate("MainWindow", "TextLabel", 0, QApplication::UnicodeUTF8));
        sendButton->setText(QApplication::translate("MainWindow", "PushButton", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
