/* minichat_subscriber.cxx
   ...
   rtiddsgen -language C++ -example <arch> minichat.idl

   Example subscription of type MiniChat automatically generated by 
   'rtiddsgen'. To test them follow these steps:

   (1) Compile this file and the example publication.

   (2) Start the subscription with the command
       objs/<arch>/minichat_subscriber <domain_id> <sample_count>

   (3) Start the publication with the command
       objs/<arch>/minichat_publisher <domain_id> <sample_count>
   ...
   Example:
       ...
       objs/<arch>/minichat_publisher <domain_id> 
       objs/<arch>/minichat_subscriber <domain_id> 
...
class MiniChatListener : public DDSDataReaderListener {
  public:
...
void MiniChatListener::on_data_available(DDSDataReader* reader)
{
...
extern "C" int subscriber_main(int domainId, int sample_count)
{
    ...
    DDSTopic *topic = NULL;
    MiniChatListener *reader_listener = NULL; 
    ...
    reader_listener = new MiniChatListener();
    ...
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {
        ...
        printf("MiniChat subscriber sleeping for %d sec...\n",
               receive_period.sec);
